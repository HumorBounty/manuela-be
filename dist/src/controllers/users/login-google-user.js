...
const login_google_user_1 = __importDefault(require("../../services/users/login-google-user"));
const loginGoogleController = (httpRequest) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { res, err } = yield (0, login_google_user_1.default)(httpRequest.body);
        if (res) {
